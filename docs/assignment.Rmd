...
We expect that climate change might increase amount of carbon available in the atmosphere. Given out model's high sensitivity to the r parameter (early exponential growth rate), it is likely that initial forest growth would be most strongly impacted. 
